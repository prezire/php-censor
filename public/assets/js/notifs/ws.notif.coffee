...
class @WsNotif
  ...
  renderUi: (projectTitle, type) ->
    ...
    ###
    @KLUDGE:  Notify class  Fetched from npm install notifyjs. 
    We've temporarily copied this file manually all the way to 
    the public/js folder until it's decided how to properly import 
    it from root/node_modules.
    ###
