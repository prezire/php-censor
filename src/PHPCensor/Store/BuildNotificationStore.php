<?php namespace PHPCensor\Store;
use b8\Database;
use b8\Store\Factory;
use PHPCensor\Model\BuildNotification;
use b8\Exception\HttpException;
use PHPCensor\Store;
final class BuildNotificationStore extends Store
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    protected $modelName  = '\PHPCensor\Model\BuildNotification';
    ...
    /**
     * Get a single Build Notification by Id.
     * @param integer $id
     * @param string  $useConnection
     * @return Build|null
    ...
    public function getById($id, $useConnection = 'read')
    {
        ...
        $query = 'SELECT * FROM {{build_notifications}} WHERE {{id}} = :id LIMIT 1';
